...
public class PessoaClienteService {
    ...
    public Pessoa registrar(PessoaClienteRequestDTO pessoaClienteRequestDTO) {
        ...
        // emailService.enviarEmailTexto(objetoNovo.getEmail(), "Cadastro na Loja
        // Tabajara", "O registro na loja foi realizado com sucesso. Em breve você
        ...
        emailService.enviarEmailTemplate(objetoNovo.getEmail(), "Cadastro na Loja WEEPINK", proprMap);
        return objetoNovo;
    }
