...
public class PessoaGerenciamentoService {
    ...
    public String solicitarCodigo(String email) {
        ...
        pessoa.setCodigoRecuperacaoSenha(getCodigoRecuperacaoSenha(pessoa.getIdPessoa()));
     ...
     * 
     * Pessoa pessoaBanco =
     * pessoaRepository.findByEmailAndCodigoRecuperacaoSenha(pessoa.getEmail(),
     * pessoa.getCodigoRecuperacaoSenha());
     * if (pessoaBanco != null) {
     * Date diferenca = new Date(new Date().getTime() -
     * pessoaBanco.getDataEnvioCodigo().getTime());
